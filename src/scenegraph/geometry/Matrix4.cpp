...
Matrix4 Matrix4Multiply(const Matrix4& m1, const Matrix4& m2) {
	...
	out.m13 = m1.m11 * m2.m14 + m1.m12 * m2.m24 + m1.m13 * m2.m34 + m1.m14 * m2.m44;
	...
	out.m23 = m1.m21 * m2.m14 + m1.m22 * m2.m24 + m1.m23 * m2.m34 + m1.m24 * m2.m44;
	...
	out.m33 = m1.m31 * m2.m14 + m1.m32 * m2.m24 + m1.m33 * m2.m34 + m1.m34 * m2.m44;
	...
	out.m43 = m1.m41 * m2.m14 + m1.m42 * m2.m24 + m1.m43 * m2.m34 + m1.m44 * m2.m44;
	
	return out;
}

Matrix4 Matrix4Invert(const Matrix4& m, bool* invertible) {
	float A2323 = m.m33 * m.m44 - m.m34 * m.m43;
	float A1323 = m.m32 * m.m44 - m.m34 * m.m42;
	float A1223 = m.m32 * m.m43 - m.m33 * m.m42;
	float A0323 = m.m31 * m.m44 - m.m34 * m.m41;
	float A0223 = m.m31 * m.m43 - m.m33 * m.m41;
	float A0123 = m.m31 * m.m42 - m.m32 * m.m41;
	float A2313 = m.m23 * m.m44 - m.m24 * m.m43;
	float A1313 = m.m22 * m.m44 - m.m24 * m.m42;
	float A1213 = m.m22 * m.m43 - m.m23 * m.m42;
	float A2312 = m.m23 * m.m34 - m.m24 * m.m33;
	float A1312 = m.m22 * m.m34 - m.m24 * m.m32;
	float A1212 = m.m22 * m.m33 - m.m23 * m.m32;
	float A0313 = m.m21 * m.m44 - m.m24 * m.m41;
	float A0213 = m.m21 * m.m43 - m.m23 * m.m41;
	float A0312 = m.m21 * m.m34 - m.m24 * m.m31;
	float A0212 = m.m21 * m.m33 - m.m23 * m.m31;
	float A0113 = m.m21 * m.m42 - m.m22 * m.m41;
	float A0112 = m.m21 * m.m32 - m.m22 * m.m31;

	float det =
		  m.m11 * (m.m22 * A2323 - m.m23 * A1323 + m.m24 * A1223)
	...
	if (invertible) {
		*invertible = det > std::numeric_limits<float>::epsilon();
		if (!*invertible) {
	...
	return Matrix4 {
		/* m11 */ det *  (m.m22 * A2323 - m.m23 * A1323 + m.m24 * A1223),
		/* m12 */ det * -(m.m12 * A2323 - m.m13 * A1323 + m.m14 * A1223),
		/* m13 */ det *  (m.m12 * A2313 - m.m13 * A1313 + m.m14 * A1213),
		/* m14 */ det * -(m.m12 * A2312 - m.m13 * A1312 + m.m14 * A1212),
		/* m21 */ det * -(m.m21 * A2323 - m.m23 * A0323 + m.m24 * A0223),
		/* m22 */ det *  (m.m11 * A2323 - m.m13 * A0323 + m.m14 * A0223),
		/* m23 */ det * -(m.m11 * A2313 - m.m13 * A0313 + m.m14 * A0213),
		/* m24 */ det *  (m.m11 * A2312 - m.m13 * A0312 + m.m14 * A0212),
		/* m31 */ det *  (m.m21 * A1323 - m.m22 * A0323 + m.m24 * A0123),
		/* m32 */ det * -(m.m11 * A1323 - m.m12 * A0323 + m.m14 * A0123),
		/* m33 */ det *  (m.m11 * A1313 - m.m12 * A0313 + m.m14 * A0113),
		/* m34 */ det * -(m.m11 * A1312 - m.m12 * A0312 + m.m14 * A0112),
		/* m41 */ det * -(m.m21 * A1223 - m.m22 * A0223 + m.m23 * A0123),
		/* m42 */ det *  (m.m11 * A1223 - m.m12 * A0223 + m.m13 * A0123),
		/* m43 */ det * -(m.m11 * A1213 - m.m12 * A0213 + m.m13 * A0113),
		/* m44 */ det *  (m.m11 * A1212 - m.m12 * A0212 + m.m13 * A0112)
	};
}
